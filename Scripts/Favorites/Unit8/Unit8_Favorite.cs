...
public class Unit8_Favorites : MonoBehaviour
{
    public const int QuestionCount = 6;

    public static bool[] IsFavoriteUnit8 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit8)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit8[numberCard - 1])
    ...
    {
        IsFavoriteUnit8[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit8[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit8.Clone();
    }
