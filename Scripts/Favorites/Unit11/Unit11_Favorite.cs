...
public class Unit11_Favorites : MonoBehaviour
{
    public const int QuestionCount = 5;

    public static bool[] IsFavoriteUnit11 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit11)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit11[numberCard - 1])
    ...
    {
        IsFavoriteUnit11[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit11[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit11.Clone();
    }
