...
public class Unit4_Favorites : MonoBehaviour
{
    public const int QuestionCount = 6;

    public static bool[] IsFavoriteUnit4 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit4)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit4[numberCard - 1])
    ...
    {
        IsFavoriteUnit4[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit4[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit4.Clone();
    }
