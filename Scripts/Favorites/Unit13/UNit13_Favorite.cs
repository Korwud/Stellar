...
public class Unit13_Favorites : MonoBehaviour
{
    public const int QuestionCount = 10;

    public static bool[] IsFavoriteUnit13 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit13)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit13[numberCard - 1])
    ...
    {
        IsFavoriteUnit13[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit13[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit13.Clone();
    }
