...
public class Unit2_Favorites : MonoBehaviour
{
    public const int QuestionCount = 3;

    public static bool[] IsFavoriteUnit2 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit2)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit2[numberCard - 1])
    ...
    {
        IsFavoriteUnit2[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit2[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit2.Clone();
    }
