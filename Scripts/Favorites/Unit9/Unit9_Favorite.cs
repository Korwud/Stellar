...
public class Unit9_Favorites : MonoBehaviour
{
    public const int QuestionCount = 3;

    public static bool[] IsFavoriteUnit9 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit9)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit9[numberCard - 1])
    ...
    {
        IsFavoriteUnit9[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit9[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit9.Clone();
    }
