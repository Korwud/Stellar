...
public class Unit7_Favorites : MonoBehaviour
{
    public const int QuestionCount = 7;

    public static bool[] IsFavoriteUnit7 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit7)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit7[numberCard - 1])
    ...
    {
        IsFavoriteUnit7[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit7[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit7.Clone();
    }
