...
public class Unit12_Favorites : MonoBehaviour
{
    public const int QuestionCount = 4;

    public static bool[] IsFavoriteUnit12 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit12)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit12[numberCard - 1])
    ...
    {
        IsFavoriteUnit12[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit12[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit12.Clone();
    }
