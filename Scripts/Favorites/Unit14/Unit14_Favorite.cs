...
public class Unit14_Favorites : MonoBehaviour
{
    public const int QuestionCount = 5;

    public static bool[] IsFavoriteUnit14 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit14)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit14[numberCard - 1])
    ...
    {
        IsFavoriteUnit14[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit14[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit14.Clone();
    }
