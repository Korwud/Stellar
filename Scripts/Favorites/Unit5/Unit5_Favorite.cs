...
public class Unit5_Favorites : MonoBehaviour
{
    public const int QuestionCount = 7;

    public static bool[] IsFavoriteUnit5 = new bool[QuestionCount];
    ...
    {
        var count = 0;
        foreach (var i in IsFavoriteUnit5)
        {
            if (i is true)
                count++;
        }
    ...
    public void Update()
    {
        ...
        {
            if (IsFavoriteUnit5[numberCard - 1])
    ...
    {
        IsFavoriteUnit5[numberCard - 1] = true;
        Clone[numberCard - 1] = true;
    }

    public void FromFavorite()
    {
        IsFavoriteUnit5[numberCard - 1] = false;
    ...
    {
        Clone = (bool[])IsFavoriteUnit5.Clone();
    }
